...
{
    public class Arrestee: OldLibrsValues
    {
        ...
        [JsonProperty("arrTransactionNumber")]
        public string ArrTransactionNumber { get; set; }
        
        [JsonProperty("arresteeName")]
        public string ArresteeName { get; set; }
        
        [JsonProperty("arrestDate")]
        public string ArrestDate { get; set; }
        
        [JsonProperty("arrestType")]
        public string ArrestType { get; set; }
        
        [JsonProperty("multipleArresteeIndicator")]
        public string MultipleArresteeIndicator { get; set; }
        ...
        [JsonProperty("dispositionUnder17")]
        public string DispositionUnder17 { get; set; }
